...
const resources = {
  ...
  login: { /* … */ },
      ...
      navCompany: 'Company',
      navAuthGroup: 'Identity',
      navStorageGroup: 'Storage',
      ...
      storageStatsUploads7d: 'Uploads (7d)',
      storageStatsToday: 'today',
      storageStatsCompaniesHint: '{{count}} companies',
      storageStatsDailyTitle: 'Uploads · last 14 days',
      storageStatsDailyDescription: 'Daily upload count',
      storageStatsFamiliesTitle: 'By type',
      storageStatsFamiliesDescription: 'MIME families',
      storageStatsBucketsTitle: 'Top buckets',
      storageStatsQuotasTitle: 'Company quotas',
      storageStatsRecentTitle: 'Recent uploads',
      storageStatsEmpty: 'No data yet.',
      storageStatsColFamily: 'Family',
      storageStatsColFiles: 'Files',
      storageStatsColSize: 'Size',
      storageStatsColBucket: 'Bucket',
      storageStatsColCompany: 'Company',
      storageStatsColUsed: 'Used',
      storageStatsColLimit: 'Limit',
      storageStatsColFile: 'File',
      storageStatsColMime: 'MIME',
      storageStatsGeneratedAt: 'Generated {{value}}',
      navApplicationsGroup: 'Applications',
      navOAuth: 'OAuth apps',
      navGroups: 'Groups',
      navUsers: 'Users',
      ...
      dashboardCompanyDescription:
        'Update your company record and how new users join this tenant (API: PATCH /api/v1/companies/…).',
      dashboardCompanyNameLabel: 'Company name',
      dashboardCompanySlugLabel: 'Slug',
      dashboardCompanyAccessTitle: 'Company access',
      dashboardCompanyAccessDescription:
        'Choose how OAuth sign-ins grant access. Public is open; domain allow-lists matching emails; invitation-only waits for an admin to enable the account.',
      dashboardCompanyAccessModeLabel: 'Join mode',
      dashboardCompanyAccessMode_public: 'Public',
      dashboardCompanyAccessMode_domain: 'Domain allow list',
      dashboardCompanyAccessMode_invite: 'Invitation only',
      dashboardCompanyAccessModeHint_public:
        'Anyone who signs in joins and gets access immediately.',
      dashboardCompanyAccessModeHint_domain:
        'Matching email domains get access. Other domains are blocked and owners are emailed.',
      dashboardCompanyAccessModeHint_invite:
        'New accounts are created inactive. Owners are emailed until someone enables access.',
      dashboardCompanyDomainsLabel: 'Allowed email domains',
      dashboardCompanyDomainsPlaceholder: 'acme.com, acme.co.uk',
      dashboardCompanyDomainsHint:
        'Comma-separated domains without @. Subdomains of a listed domain also match.',
      dashboardCompanyDomainsRequired: 'Add at least one domain for domain mode.',
      ...
      usersTableDescription:
        'Access is per company for this tenant. Enable / Disable only affects membership here, not other companies.',
      ...
      usersStaffYes: 'yes',
      usersStaffNo: 'no',
      usersActiveYes: 'enabled',
      usersActiveNo: 'disabled',
      usersAccessSelectLabel: 'Company access for {{name}}',
      usersActionEdit: 'Edit',
      usersActionView: 'View',
      usersActionEnable: 'Enable access',
      usersActionDisable: 'Disable access',
      usersAccessEnabledToast: 'Company access enabled (user notified by email)',
      usersAccessDisabledToast: 'Company access disabled',
      ...
      userDetailMembershipHint:
        'Company owners and staff can assign groups for this organization; JWT group claims update on the user’s next token refresh. Use Enable / Disable access to grant or revoke sign-in for this company only (emails the user when enabling).',
      ...
      accessTokensLoading: 'Loading tokens…',
      accessTokensEmpty: 'No tokens yet.',
      ...
      accessTokensReadOnlyHint:
        'When enabled, only safe HTTP methods are allowed. Uncheck to allow creating and changing data as yourself.',
      accessTokensGlobalMetricsLabel: 'Global metrics (all companies)',
      accessTokensGlobalMetricsHint:
        'Staff only. Allows GET /api/v1/metrics/all (cross-company). Same privilege as Django staff session JWT.',
      accessTokensColName: 'Label',
      accessTokensColAccess: 'Access',
      accessTokensColCreated: 'Created',
      accessTokensColLastUsed: 'Last used',
      accessTokensColStatus: 'Status',
      accessTokensColActions: 'Actions',
      accessTokensAccessReadOnly: 'Read-only',
      accessTokensAccessReadWrite: 'Read & write',
      accessTokensColMetrics: 'Metrics scope',
      accessTokensMetricsCompany: 'Company',
      accessTokensMetricsGlobal: 'All companies',
      accessTokensStatusActive: 'Active',
      accessTokensStatusRevoked: 'Revoked',
      accessTokensRevoke: 'Revoke',
      accessTokensRevoking: 'Revoking…',
      accessTokensCopied: 'Copied to clipboard',
      accessTokensCopy: 'Copy token',
      accessTokensOnceTitle: 'Save this token now',
      accessTokensOnceHint:
        'You will not see this secret again. Copy it to your secrets store, then click Done.',
      accessTokensDismiss: 'Done',
      accessTokensError: 'Could not update access tokens.',
  ...
  login: { /* … */ },
      ...
      navAuthGroup: 'Identité',
      navStorageGroup: 'Stockage',
      ...
      storageStatsDocuments: 'Documents',
      storageStatsBuckets: 'Buckets',
      storageStatsUploads7d: 'Téléversements (7j)',
      storageStatsToday: 'aujourd’hui',
      storageStatsCompaniesHint: '{{count}} entreprises',
      storageStatsDailyTitle: 'Téléversements · 14 derniers jours',
      storageStatsDailyDescription: 'Nombre de téléversements par jour',
      storageStatsFamiliesTitle: 'Par type',
      storageStatsFamiliesDescription: 'Familles MIME',
      storageStatsBucketsTitle: 'Top buckets',
      storageStatsQuotasTitle: 'Quotas entreprise',
      storageStatsRecentTitle: 'Téléversements récents',
      storageStatsEmpty: 'Pas encore de données.',
      storageStatsColFamily: 'Famille',
      storageStatsColFiles: 'Fichiers',
      storageStatsColSize: 'Taille',
      storageStatsColBucket: 'Bucket',
      storageStatsColCompany: 'Entreprise',
      storageStatsColUsed: 'Utilisé',
      storageStatsColLimit: 'Limite',
      storageStatsColFile: 'Fichier',
      storageStatsColMime: 'MIME',
      storageStatsGeneratedAt: 'Généré {{value}}',
      navApplicationsGroup: 'Applications',
      navOAuth: 'Apps OAuth',
      navGroups: 'Groupes',
      ...
      dashboardCompanyDescription:
        'Mettez à jour la fiche entreprise et les règles d’accès des nouveaux utilisateurs (API : PATCH /api/v1/companies/…).',
      dashboardCompanyNameLabel: 'Nom de l’entreprise',
      dashboardCompanySlugLabel: 'Identifiant (slug)',
      dashboardCompanyAccessTitle: 'Accès entreprise',
      dashboardCompanyAccessDescription:
        'Choisissez comment les connexions OAuth accordent l’accès. Public est ouvert ; le domaine autorise les e-mails correspondants ; invitation seule attend qu’un admin active le compte.',
      dashboardCompanyAccessModeLabel: 'Mode d’adhésion',
      dashboardCompanyAccessMode_public: 'Public',
      dashboardCompanyAccessMode_domain: 'Liste de domaines',
      dashboardCompanyAccessMode_invite: 'Sur invitation',
      dashboardCompanyAccessModeHint_public:
        'Toute personne qui se connecte rejoint l’entreprise et obtient l’accès immédiatement.',
      dashboardCompanyAccessModeHint_domain:
        'Les domaines e-mail correspondants ont accès. Les autres sont bloqués et les propriétaires sont notifiés.',
      dashboardCompanyAccessModeHint_invite:
        'Les nouveaux comptes sont créés inactifs. Les propriétaires sont notifiés jusqu’à activation.',
      dashboardCompanyDomainsLabel: 'Domaines e-mail autorisés',
      dashboardCompanyDomainsPlaceholder: 'acme.com, acme.co.uk',
      dashboardCompanyDomainsHint:
        'Domaines séparés par des virgules, sans @. Les sous-domaines d’un domaine listé correspondent aussi.',
      dashboardCompanyDomainsRequired: 'Ajoutez au moins un domaine pour le mode domaine.',
      ...
      usersTableDescription:
        'L’accès est par entreprise pour ce tenant. Activer / Désactiver ne concerne que l’appartenance ici, pas les autres sociétés.',
      ...
      usersStaffYes: 'oui',
      usersStaffNo: 'non',
      usersActiveYes: 'activé',
      usersActiveNo: 'désactivé',
      usersAccessSelectLabel: 'Accès entreprise pour {{name}}',
      usersActionEdit: 'Modifier',
      usersActionView: 'Voir',
      usersActionEnable: 'Activer l’accès',
      usersActionDisable: 'Désactiver l’accès',
      usersAccessEnabledToast: 'Accès entreprise activé (utilisateur notifié par e-mail)',
      usersAccessDisabledToast: 'Accès entreprise désactivé',
      ...
      userDetailMembershipHint:
        'Les propriétaires d’entreprise et le staff peuvent attribuer des groupes pour cette organisation ; les claims JWT se mettent à jour au prochain renouvellement du jeton. Utilisez Activer / Désactiver l’accès pour cette société uniquement (e-mail à l’utilisateur lors de l’activation).',
      ...
      accessTokensLoading: 'Chargement des jetons…',
      accessTokensEmpty: 'Aucun jeton pour l’instant.',
      ...
      accessTokensReadOnlyHint:
        'Si activé, seuls les verbes HTTP sûrs sont autorisés. Décochez pour autoriser la création et la modification des données en votre nom.',
      accessTokensGlobalMetricsLabel: 'Métriques globales (toutes les entreprises)',
      accessTokensGlobalMetricsHint:
        'Réservé au staff. Autorise GET /api/v1/metrics/all (toutes entreprises). Équivalent à une session staff Django.',
      accessTokensColName: 'Libellé',
      accessTokensColAccess: 'Accès',
      accessTokensColCreated: 'Création',
      accessTokensColLastUsed: 'Dernière utilisation',
      accessTokensColStatus: 'Statut',
      accessTokensColActions: 'Actions',
      accessTokensAccessReadOnly: 'Lecture seule',
      accessTokensAccessReadWrite: 'Lecture et écriture',
      accessTokensColMetrics: 'Portée métriques',
      accessTokensMetricsCompany: 'Entreprise',
      accessTokensMetricsGlobal: 'Toutes entreprises',
      accessTokensStatusActive: 'Actif',
      accessTokensStatusRevoked: 'Révoqué',
      accessTokensRevoke: 'Révoquer',
      accessTokensRevoking: 'Révocation…',
      accessTokensCopied: 'Copié dans le presse-papiers',
      accessTokensCopy: 'Copier le jeton',
      accessTokensOnceTitle: 'Enregistrez ce jeton maintenant',
      accessTokensOnceHint:
        'Vous ne pourrez plus afficher ce secret. Copiez-le dans votre coffre-fort de secrets, puis cliquez sur Terminé.',
      accessTokensDismiss: 'Terminé',
      accessTokensError: 'Impossible de mettre à jour les jetons d’accès.',
      brandSubtitle: 'Administration',
      groupsTitle: 'Groupes',
      groupsDescription:
